  ...
  return (
    <section className="w-full bg-[#F6F5F2] font-sans relative overflow-hidden">
      <div className="w-full bg-[#044647] rounded-t-[40px] lg:rounded-t-[60px] py-12 md:py-16 relative overflow-hidden">
        <div className="max-w-360 mx-auto px-4 sm:px-6 md:px-12 lg:px-16">
          ...
          <div className="flex flex-col lg:flex-row justify-between items-center gap-12 lg:gap-24 w-full">
            ...
            <div className="w-full lg:w-[50%] h-full flex flex-col text-left relative z-10 gap-5 sm:gap-6">
              <span 
              ...
              <h2
                className="font-manrope tracking-tight font-semibold text-[32px] sm:text-[42px] lg:text-[56px] leading-tight sm:leading-13 lg:leading-[64px] text-white"
              >
                Shaping People <br className="hidden sm:inline" />And Performance
              </h2>

              <p 
                className="font-dm-sans text-white font-normal text-[16px] sm:text-[18px] leading-6.5 sm:leading-7"
              >
              ...
              <div className="flex items-center gap-3">
                <Link
                  href="/about"
                  className="font-dm-sans px-7 sm:px-8 py-3.5 rounded-full shadow-md hover:shadow-lg transition-all hover:scale-105 flex items-center justify-center bg-[#C6D936] text-[#051B05] font-medium text-[16px] sm:text-[18px] leading-7.5"
                >
                  Get Started
                </Link>
                <Link
            ...
            <div className="w-full lg:w-[50%] relative flex flex-col lg:flex-row items-center justify-end min-h-auto lg:min-h-150 gap-6 lg:gap-0">
              ...
              <div className="w-full lg:w-[92%] rounded-3xl lg:rounded-[40px] overflow-hidden shadow-2xl relative">
                <img
                  ...
                  className="w-full h-80 sm:h-110 lg:h-135 object-cover"
                />
                <div className="absolute inset-0 bg-linear-to-t from-black/20 to-transparent" />
              </div>

              {/* Overlapping Floating Cards stacked vertically */}
              <div className="w-full lg:w-111.5 max-w-111.5 relative lg:absolute left-0 lg:left-[-15%] top-auto lg:top-1/2 lg:-translate-y-1/2 flex flex-col gap-4 sm:gap-5 z-20">
                {features.map((feature, idx) => {
                  return (
                    <motion.div
                      ...
                      className="bg-white rounded-xl p-5 sm:p-6.25 shadow-[0_15px_40px_rgba(0,0,0,0.12)] flex items-center gap-4 sm:gap-5 border border-white/80 backdrop-blur-sm"
                    >
                      ...
                      <div className="text-left">
                        <h4 
                          className="font-manrope font-semibold text-[20px] sm:text-[24px] leading-6.5 text-[#051B05]"
                        >
                          {feature.title}
                        </h4>
                        <p 
                          className="font-dm-sans text-[#595B62] font-normal mt-1 text-[15px] sm:text-[18px] leading-6 sm:leading-7" 
                        >
                          {feature.description}
                        </p>
                      </div>
