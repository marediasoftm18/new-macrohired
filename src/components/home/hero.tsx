...
export default function Hero() {
  ...
  return (
    <section className="relative isolate w-full min-h-160 sm:min-h-180 md:min-h-190 lg:min-h-205 overflow-hidden bg-[#eef4f1]">
      <div
      ...
      <div className="relative z-10 mx-auto flex min-h-140 sm:min-h-160 lg:min-h-200 w-full max-w-360 items-start px-4 sm:px-6 md:px-8 xl:px-8 pt-24 sm:pt-32 md:pt-36 lg:pt-48.25 pb-16 lg:pb-0">
        <div className="grid w-full grid-cols-1 items-start gap-10 lg:gap-8">
          <div className="flex w-full flex-col gap-0 text-left max-w-2xl lg:max-w-none">
            ...
            <motion.h1
              ...
              className="font-manrope mt-2.5 text-white font-bold text-[36px] sm:text-[52px] md:text-[68px] lg:text-[92px] leading-tight sm:leading-[1.1] md:leading-[78px] lg:leading-[110px]"
            >
            ...
            >
              <Link
                href="/about"
                className="font-dm-sans inline-flex h-13 sm:h-15 items-center rounded-full bg-[#c8db2b] px-6 sm:px-7 text-[16px] sm:text-[18px] font-medium text-[#062828] shadow-[0_8px_24px_rgba(0,0,0,0.12)] transition-transform hover:scale-[1.02]"
              >
                Get Started
              </Link>
              <Link
