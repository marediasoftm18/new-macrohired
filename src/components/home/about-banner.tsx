    ...
    <section className="w-full bg-[#F6F5F2] font-sans relative overflow-hidden">
      <div className="w-full bg-[#044647] rounded-t-[40px] lg:rounded-t-[60px] py-10 md:py-14 lg:py-16 relative overflow-hidden">
        <div className="max-w-360 mx-auto px-4 sm:px-6 md:px-8 lg:px-16">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-10 md:gap-0 lg:gap-24 w-full">
            ...
            <div className="w-full md:w-[48%] lg:w-[50%] h-full flex flex-col text-left relative z-10 gap-4 md:gap-5 lg:gap-6">
              ...
              <h2
                className="font-manrope tracking-tight font-semibold text-[30px] sm:text-[36px] md:text-[34px] lg:text-[56px] leading-tight sm:leading-11 md:leading-11 lg:leading-16 text-white"
              >
                Shaping People <br className="hidden sm:inline" />And Performance
              </h2>

              <p 
                className="font-dm-sans text-white font-normal text-[15px] md:text-[18px] lg:text-[18px] leading-6 md:leading-7 lg:leading-7"
              >
              ...
              <div className="flex items-center gap-3 mt-1">
                <Link
                  href="/about"
                  className="font-dm-sans px-6 md:px-7 lg:px-8 py-3 md:py-3.5 rounded-full shadow-md hover:shadow-lg transition-all hover:scale-105 flex items-center justify-center bg-[#C6D936] text-[#051B05] font-medium text-[15px] md:text-[18px] lg:text-[18px] leading-7.5"
                >
                  Get Started
                </Link>
                <Link
            ...
            <div className="w-full md:w-[70%] lg:w-[50%] relative flex flex-col md:flex-row items-center justify-end min-h-auto md:min-h-120 lg:min-h-150 gap-4 md:gap-0">
              {/* Main Image */}
              <div className="w-full md:w-[90%] lg:w-[92%] rounded-3xl lg:rounded-[40px] overflow-hidden shadow-2xl relative">
                <img
                  ...
                  className="w-full h-72 sm:h-96 md:h-120 lg:h-135 object-cover"
                />
                <div className="absolute inset-0 bg-linear-to-t from-black/20 to-transparent" />
              </div>

              {/* Feature Cards Overlapping Image */}
              <div className="w-full md:w-[85%] lg:w-111.5 max-w-111.5 relative md:absolute left-0 md:left-[12.5%] lg:left-[-15%] top-auto md:top-1/2 md:-translate-y-1/2 flex flex-col gap-3.5 md:gap-4 lg:gap-5 z-20">
                {features.map((feature, idx) => {
                  return (
                    <motion.div
                      ...
                      className="bg-white rounded-2xl md:rounded-2xl md:items-start p-4.5 md:p-5 lg:p-6.25 shadow-[0_15px_40px_rgba(0,0,0,0.12)] flex items-center gap-4 border border-white/80 backdrop-blur-sm"
                    >
                      ...
                      <div className="text-left">
                        <h4 
                          className="font-manrope font-semibold text-[17px] md:text-[20px] lg:text-[24px] leading-6 md:leading-6.5 lg:leading-7 text-[#051B05]"
                        >
                          {feature.title}
                        </h4>
                        <p 
                          className="font-dm-sans text-[#595B62] font-normal mt-0.5 text-[14px] md:text-[18px] lg:text-[18px] leading-5.5 md:leading-7 lg:leading-7" 
                        >
                          {feature.description}
                        </p>
                      </div>
