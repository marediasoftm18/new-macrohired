...
export default function AboutVision() {
  return (
    <section className="w-full bg-white py-14 md:py-20 lg:py-28 font-sans overflow-hidden">
      <div className="w-full max-w-360 px-4 sm:px-6 xl:px-8 mx-auto">
        
        {/* 3 Clean Horizontal Columns Layout */}
        <div className="flex flex-col lg:flex-row justify-between items-center lg:items-start gap-8 lg:gap-6 w-full">
          ...
          <div className="flex-1 w-full flex flex-col text-left gap-6 pr-0 lg:pr-6.25">
            {/* Tag */}
            ...
            {/* Title */}
            <h2 className="font-manrope font-semibold text-[32px] sm:text-[42px] lg:text-[52px] leading-tight sm:leading-13 lg:leading-15.5 text-[#051B05]">
            ...
            <div className="flex items-center gap-5 pt-2 pb-4 border-b border-gray-200/80">
              <span className="font-manrope text-[64px] sm:text-[80px] lg:text-[90px] font-bold text-[#044647] leading-none flex items-center">
            ...
            <div className="flex flex-wrap items-center gap-4 pt-4">
              ...
              {/* Avatar Stack */}
              <div className="flex items-center -space-x-2.5 overflow-hidden ml-2">
                <img
