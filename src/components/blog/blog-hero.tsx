...
export default function BlogHero() {
  return (
    <section className="w-full font-sans">
      ...
      <div className="w-full relative h-56 sm:h-72 md:h-88 lg:h-96 overflow-hidden flex items-center">
      ...
      <div className="w-full bg-[#F6F5F2] py-3 sm:py-3.5 border-b border-gray-200/60">
        <div className="w-full max-w-360 px-4 sm:px-6 md:px-8 lg:px-12 mx-auto flex items-center gap-2 font-dm-sans text-[13px] sm:text-[15px] md:text-[16px] leading-6 text-[#044647]">
          ...
          <span className="text-[#044647] font-semibold">Blog</span>
        </div>
      </div>
    </section>
  );
