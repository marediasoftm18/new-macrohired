    ...
    <section className="w-full bg-white pb-16 md:pb-24 px-6 md:px-16 font-sans">
      <div className="w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="lg:col-span-8 bg-[#044647] rounded-4xl overflow-hidden flex flex-col md:flex-row relative min-h-80 shadow-sm">
            {/* Watermark Pattern */}
            ...
            {/* Left Image & Overlay */}
            <div className="relative w-full md:w-[45%] min-h-55 md:min-h-full overflow-hidden shrink-0">
              <img
              ...
              <div className="absolute inset-0 bg-linear-to-t md:bg-linear-to-r from-teal-950/20 via-[#C6D936]/30 to-[#044647]" />
            </div>
            ...
            <div className="w-full md:w-[55%] p-8 md:p-12 flex flex-col justify-center gap-5 relative z-10 text-left">
              ...
              <div className="bg-white rounded-full p-1.5 flex items-center shadow-sm w-full max-w-md border border-white/10">
                <input
                  ...
                  className="grow bg-transparent border-none outline-none text-xs md:text-sm text-gray-700 px-4 placeholder:text-gray-400"
                />
                <button
          ...
          <div
            className="lg:col-span-4 bg-[#C6D936] rounded-4xl p-8 flex flex-col justify-between text-[#044647] relative overflow-hidden min-h-80 shadow-sm"
            style={{
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="text-left flex items-baseline gap-2">
                  ...
                  <span className="text-xs text-[#044647] font-semibold leading-tight max-w-30" style={{ fontFamily: "var(--font-dm-sans), sans-serif" }}>
